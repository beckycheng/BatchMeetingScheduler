...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
  <head>
    ...
    <title>{{ __('Meeting') }} | {{ config('app.name') }}</title>
            ...
            <tr>
              <td align="center"  bgcolor="#343e9e" class="container-padding">
                ...
                <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" dir="rtl">
                              <tr>
                                ...
                                <td>
                                  <![endif]-->
                                  <!-- column -->
                                  <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="280" style="width:280px;max-width:280px;display:none">
                                    <tr  >
                                      <td align="center" class="center-text">
                                        {{-- <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ __('https://www.polyu.edu.hk/-/media/department/home/setting/favicon.ico') }}" width="72" border="0"  alt="{{ config('app.name') }}"></a> --}}
                                        {{-- <a href="{{ url('/') }}"><img style="width:72px;border:0px;display: inline!important;" src="{{ asset('favicon.ico') }}" width="72" border="0"  alt="{{ config('app.name') }}"></a> --}}
                                      </td>
                                    </tr>
                                  </table>
                                  <!-- column -->
                  ...
                  <tr  >
                    <td align="center" class="center-text">
                      <img style="width:190px;border:0px;display: inline!important;" src="{{ __('https://raw.githubusercontent.com/simplepleb/laravel-email-templates/96ae3cb0a6f720a406f80e3d1ecd8252022b48a4/public/assets/img/emails/Email-8_Intro.png') }}" width="190" border="0"       alt="intro">
                      {{-- <img style="width:190px;border:0px;display: inline!important;" src="{{ asset('assets/img/emails/Email-8_Intro.png') }}" width="190" border="0"       alt="intro"> --}}
                    </td>
                  </tr>
                  <tr  >
                    <td height="40" style="font-size:40px;line-height:40px;" >&nbsp;</td>
                  ...
                  <tr  >
                    <td class="center-text"  align="center" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:42px;line-height:52px;font-weight:400;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                      <div  >
                        {{ __('Please sign in and arrange your time slots preference') }}
                      </div>
                    </td>
                  </tr>
                  <tr  >
          ...
          <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;" >
            ...
            <tr  >
              <td align="center"  bgcolor="#FFFFFF">
                <img style="width:50px;border:0px;display: inline!important;" src="{{ __('https://raw.githubusercontent.com/simplepleb/laravel-email-templates/96ae3cb0a6f720a406f80e3d1ecd8252022b48a4/public/assets/img/emails/Arrow.png') }}" width="50" border="0"       alt="arrow">
                      ...
                      <table border="0" cellspacing="0" cellpadding="0" role="presentation" align="center" class="row" width="480" style="width:480px;max-width:480px;">
                        <tr>
                          <td class="center-text"  align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:26px;font-weight:400;font-style:italic;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                            <div  >
                              ({{ __('If you have any questions, ') }} <a href="mailto:{{ config('pleb.mail.info_email') }}" style="color:#ed6e7a;text-decoration: underline;">{{ __('reply to this email') }}</a>)
                            </div>
                          </td>
                        </tr>
                      </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" align="center">
                              <tr>
                                ...
                                <td align="center" height="50" style="height:50px;">
                                  <![endif]-->
                                  <a href="{{ route('meeting.choose', $params['meeting']) }}" target="_blank" style="font-family:'Roboto Slab',Arial,Helvetica,sans-serif;font-size:16px;line-height:19px;font-weight:700;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;padding: 20px 50px 20px 50px;display: inline-block;"><span>{{ __('Choose Time') }}</span></a>
                                  <!--[if (gte mso 9)|(IE)]>
                                </td>
                                <td align="center" width="50"></td>
                              </tr>
